<footer>
  <div class="readable">
    Notice something wrong or think we should add an example? Let us know <a
      target="_blank"
      rel="noopener"
      href="https://github.com/syntaxfm/css-has/issues">on Github</a
    >.
  </div>
  <div class="presented">
    <div class="cred">
      <img class="logo" src="/syntax.png" alt="syntax logo" />
      <span>×</span>
    ...
    <p class="readable">
      ...
      actually matters, solve what's urgent faster, and learn continuously about
      their code.
    </p>
    <a
  ...
  <div class="copyright"><p>©️ 2024 - Sentry.io</p></div>
</footer>
...
<style>
  ...
  .presented {
    ...
    padding: 1rem;
    margin: 2rem 0;
    background: url(/squiggle-greyscale.webp),
